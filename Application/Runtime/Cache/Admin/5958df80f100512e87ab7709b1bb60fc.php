    ...
    <div class="container-fluid" style="background: salmon;">
        <div class="row-fluid" style="margin-top: 0px;">
            <div style="float: right;">
                <form action="<?php echo U('User/userLoginLog');?>" id="uploadForm"  class="form-horizontal" method="post">
            ...
            <div class="span12">
                ...
                <div class="widget-box">
                    <div class="widget-title bg_ly" data-toggle="collapse" href="#collapseG2"><span class="icon"><i class="icon-chevron-down"></i></span>
                        <h5><i class="icon-th" style="margin-right: 10px;"></i>用户登陆记录列表</h5>
                    </div>
                    <div class="widget-content nopadding in collapse" id="collapseG2" style="height: auto;width: 100%;">
                        <table class="table table-bordered data-table" >
                            ...
                            <tbody>
                            <?php if(is_array($loginLogList)): $k = 0; $__LIST__ = $loginLogList;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($k % 2 );++$k;?><tr class="gradeX" >
                                    ...
                                    <td style="text-align: center;width: 15%;">(<?php echo ($vo["latitude"]); ?>,<?php echo ($vo["longitude"]); ?>)</td>
                                    <td  style="text-align: center;width: 20%;">
                                        <a target="detailUserInfo<?php echo ($vo["id"]); ?>"  href="<?php echo U('User/detailUserInfo',array('id'=>$vo['id']));?>" ><span class="badge badge-info"><li style="margin-right: 5px;" class="icon-user" title="查看用户详情"></li>用户详情</span></a>
                                        <a target="loaction<?php echo ($vo["id"]); ?>"  href="http://m.amap.com/navi/?dest=<?php echo ($vo["longitude"]); ?>,<?php echo ($vo["latitude"]); ?>&destName=<?php echo ($vo["nickname"]); ?> 在 <?php echo ($vo["time"]); ?> 的登陆地点&hideRouteIcon=1&key=<?php echo ($amap); ?>" ><span class="badge badge-warning"><li style="margin-right: 5px;" class="icon-map-marker" title="用户登陆地点"></li>地点详情</span></a>
                                    </td>
