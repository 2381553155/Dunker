...
<div id="content">
    ...
    <div id="content-header">
        <div id="breadcrumb">
            ...
            <a>新闻管理</a>
            <a href="<?php echo U('news/newsList');?>" title="新闻列表" class="tip-bottom"><i class="icon-th-list"></i>新闻列表</a>
            ...
            <div class="widget-box">
                ...
                <div class="widget-content tab-content">
                    ...
                    <div id="tab1" class="tab-pane active">
                        ...
                        <form action="<?php echo U('News/saveNewsEdit');?>"  method="post"  >
                            ...
                            <div class="control-group">
                                <label >
                                    ...
                                    <span class="badge badge-warning"><?php echo ($newsInfo['id']); ?></span>
                                    <input  name="id" style="visibility: hidden;" value="<?php echo ($newsInfo['id']); ?>" />
                                </label>
                                <hr>
                            </div>
                            ...
                            <div class="control-group">
                                <label >
                                    ...
                                    <span class="badge badge-warning"><?php echo ($newsInfo['readedCount']); ?></span>
                                </label>
                                <hr>
                            </div>
                            ...
                            <div  class="controls">
                                <label >
                                    ...
                                    <select id="selectedItem" name="newsType" style="width:150px;margin-right: 10px;"  >
                                        <?php if(is_array($selectList)): $k = 0; $__LIST__ = $selectList;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($k % 2 );++$k;?><option <?php if($k == $newsInfo['newsType']): ?>selected<?php endif; ?>  value="<?php echo ($vo["value"]); ?>"><?php echo ($vo["name"]); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
                                    </select>
                                </label>
                                <hr>
                            </div>
